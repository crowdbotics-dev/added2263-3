"""
Django settings for added2263_3 project.
...
WSGI_APPLICATION = 'added2263_3.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "added2263_3 API",
    "DESCRIPTION": "API documentation for added2263_3 App",
    "VERSION": "v1",
}
